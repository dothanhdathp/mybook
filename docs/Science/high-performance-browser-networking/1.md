...
> [Sơ lược về độ trễ và băng thông](https://hpbn.co/primer-on-latency-and-bandwidth/)
...
___Độ trễ___\
Thời gian từ nguồn gửi một gói tin đến đích nhận được nó

___Băng thông___\
Thông lượng tối đa của đường truyền thông logic hoặc vật lý
...
_Bảng 1-1. Độ trễ tín hiệu trong chân không và sợi quang_
...
_Bảng 1-2. Tốc độ băng thông trung bình mà máy chủ Akamai nhìn thấy trong quý 3 năm 2015_
